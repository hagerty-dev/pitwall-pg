...
exports.validateTransaction = exports.transactionFactory = exports.executeQueryFactory = exports.canonicalize = exports.condFn = exports.cond = exports.comment = exports.param = exports.query = exports.isValidTransaction = exports.isQuery = exports.isParam = exports.QueryUtilsError = void 0;
...
function errorFactory(type, ...args) {
...
function executeQueryFactory(db) {
...
function transactionFactory(dbConnection) {
