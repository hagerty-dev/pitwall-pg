...
export function isValidTransaction(possibleTransaction) {
...
export function query(template, ...values) {
    let params = [];
...
export function param(name, value = undefined, type = "") {
...
export function comment(_string) {
    return "";
}
/*
  cond(true)`...some sql string...`
 */
export function cond(condition) {
...
*/
export function condFn(conditionFn) {
...
*/
export function canonicalize(sqlInput) {
    return sqlInput
        .split("\n")
        .map(line => line
        .trim()
...
export function makeExecutor(db) {
...
export function beginTransaction(dbConnection) {
...
export function validateTransaction(possibleTransaction) {
